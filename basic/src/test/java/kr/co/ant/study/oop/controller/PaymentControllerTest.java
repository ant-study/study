...
class PaymentControllerTest {
	...
	void testCardPayTest() throws Exception {
		mock.perform(MockMvcRequestBuilders.post("/hks/pay/card")
	...
	void testMobilePayTest() throws Exception {
		mock.perform(MockMvcRequestBuilders.post("/hks/pay/mobile")
				.param("productId", "P0001")
				.param("productName", "컴퓨터")
				.param("amount", "400000")
	...
	void testBankPayTest() throws Exception {
		mock.perform(MockMvcRequestBuilders.post("/hks/pay/bank")
				.param("productId", "P0001")
				.param("productName", "컴퓨터")
				.param("amount", "400000")
