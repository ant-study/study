...
//		value랑 length(자리수) 넣어서 비교하면 true false 뱉어내는 게 필요
		BiPredicate<String, Integer> func = (v, l) -> v.length() != l;
		CardPayment card = new CardPayment(inputVO, new BiPredicateValidatorYImpl(func));
	...
	public void doAccountPay(RequestPayInfo inputVO) throws Exception {
		...
		BiPredicate<String, Integer> func = (v, l) -> v.length() < l;
		AccountPayment account = new AccountPayment(inputVO, new BiPredicateValidatorYImpl(func));
